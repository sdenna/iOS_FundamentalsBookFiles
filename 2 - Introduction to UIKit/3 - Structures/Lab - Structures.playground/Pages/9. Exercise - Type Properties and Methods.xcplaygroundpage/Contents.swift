...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser: User = User(userName: "sdenna", email: "sdenna@d211.org", age: 42)
...
print("hi")
var denna: User = User(userName: "rdenna", email: "rdenna27@hotmail.com", age: 41)
print(User.currentUser)
User.logIn(user: denna)
print(User.currentUser)
/*:
