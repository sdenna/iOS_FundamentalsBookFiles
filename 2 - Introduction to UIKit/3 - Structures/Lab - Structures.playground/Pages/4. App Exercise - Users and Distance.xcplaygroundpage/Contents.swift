...
var shannon = User(name: "Shannon Denna", age: 43, height: 5.5, weight: 145, activityLevel: 7)
print("\(shannon.name) \(shannon.age) \(shannon.height) \(shannon.weight) \(shannon.activityLevel)")
/*:
